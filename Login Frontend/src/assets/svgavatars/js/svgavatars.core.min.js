...
window.jQuery(document).ready(function (a) {
  function L(A, e) {
      ...
      x.hasOwnProperty(B) &&
        ...
        (a('#svga-controls').append(
          '<div id="svga-controls-' +
            B +
            '" class="svga-controls"><svg class="svga-control-icon" xmlns="https://www.w3.org/2000/svg" version="1.1" viewBox="0 0 16 16" preserveAspectRatio="xMinYMin meet"><path class="svga-control-icon-path" d="' +
            x[B] +
            '"/></svg></div>'
        ),
      ...
      x.hasOwnProperty(B) &&
        ...
        a('#svga-glob-controls').append(
          '<div id="svga-glob-controls-' +
            B +
            '" class="svga-glob-controls"><svg class="svga-control-icon" xmlns="https://www.w3.org/2000/svg" version="1.1" viewBox="0 0 16 16" preserveAspectRatio="xMinYMin meet"><path class="svga-control-icon-path" d="' +
            x[B] +
            '"/></svg></div>'
        );
    for (m = 0; m < Z.length; m++)
      a('#svga-' + Z[m] + 'avatar > div').append(
        '<svg class="svga-menu-icon" xmlns="https://www.w3.org/2000/svg" version="1.1" viewBox="0 0 28 28" preserveAspectRatio="xMinYMin meet"><path class="svga-menu-icon-path" d="' +
          x[Z[m]] +
          '"/></svg>'
      );
    for (m = 0; m < aa.length; m++)
      a('#svga-' + aa[m] + '-icon').append(
        '<svg class="svga-share-icons" xmlns="https://www.w3.org/2000/svg" version="1.1" viewBox="0 0 32 32" preserveAspectRatio="xMinYMin meet"><path class="svga-share-icons-path" fill="' +
          W[m] +
          '" d="' +
          x[aa[m]] +
          '"/></svg>'
    ...
    a('#svga-saveavatar').on('click', function () {
      ...
      b =
        '<svg xmlns="https://www.w3.org/2000/svg" version="1.1" width="' +
        c.savingSize +
        'px" height="' +
        c.savingSize +
      ...
      if (c.userPro && !0 === c.userPro) {
        ...
        a.ajax({
          url: c.pathToFolder + 'php/save-userpro-avatar.php',
          type: 'post',
          dataType: 'text',
      ...
      /*a
            .ajax({
              url: c.pathToFolder + 'php/save-ready-avatar.php',
              type: 'post',
              dataType: 'text',
              data: { imgdata: e, filename: h },
              cache: !1,
    ...
    a('#svga-gravatar-ok').on('click', function () {
      ...
      a('#svga-canvas').attr({ width: 200, height: 200 });
      a.ajax({
        url: c.pathToFolder + 'php/send-to-gravatar.php',
        type: 'post',
        dataType: 'text',
        data: { imgdata: b, datastring1: e, datastring2: h, rating: d },
        cache: !1,
      })
        .done(function (b) {
          if ('success' === b)
            a('#svga-message-text').removeClass('svga-error'),
              a('#svga-loader').hide(),
              a('#svga-message-text').html(f.alertSuccessGravatar),
              a('#svga-message').fadeIn('fast');
          else
            switch (b) {
              case 'ratingfail':
    ...
    a('#svga-png-one').on('click', function () {
      a('#svga-work-overlay').fadeIn('fast');
      a('#svga-canvas').attr({
        width: c.pngFirstDownloadSize,
        height: c.pngFirstDownloadSize,
      });
      q && q.hide();
      r && r.hide();
      var b = a('#svga-svgmain').html();
      ...
      a('#svga-canvas').attr({ width: 200, height: 200 });
      a.ajax({
        url: c.pathToFolder + 'php/save-temp-avatar.php',
        type: 'post',
        dataType: 'text',
        data: { imgdata: b, filename: h },
        cache: !1,
      })
        .done(function (b) {
          'saved' === b
    ...
    a('#svga-png-two').on('click', function () {
      a('#svga-work-overlay').fadeIn('fast');
      a('#svga-canvas').attr({
        width: c.pngSecondDownloadSize,
        height: c.pngSecondDownloadSize,
      });
      q && q.hide();
      r && r.hide();
      var b = a('#svga-svgmain').html();
    ...
    if (ba)
      a('#svga-downloadavatar').on('click', function () {
        a('#svga-work-overlay').fadeIn('fast');
        a('#svga-canvas').attr({
          width: c.pngiOSDownloadSize,
          height: c.pngiOSDownloadSize,
        });
        q && q.hide();
        r && r.hide();
        var b = a('#svga-svgmain').html();
            ...
            if ('saved' === b) {
              ...
              var e = a('<img />')
                ...
                .on('load', function () {
                  ...
                  0 !== this.naturalWidth
                    ? (a('#svga-ios-image').empty().append(e),
                      a('#svga-work-overlay').fadeIn('fast'),
                      a('#svga-ios').fadeIn('fast'))
                    : (a('#svga-message-text')
                        .html(f.alertErrorImage)
                        .addClass('svga-error'),
                      a('#svga-work-overlay').fadeIn('fast'),
    ...
    if (ca)
      a('#svga-downloadavatar').on('click', function () {
        a('#svga-work-overlay').fadeIn('fast');
        a('#svga-canvas').attr({
          width: c.pngWin8TabletDownloadSize,
          height: c.pngWin8TabletDownloadSize,
        });
        q && q.hide();
        r && r.hide();
        var b = a('#svga-svgmain').html();
    ...
    a('#svga-shareavatar').on('click', function () {
      a('#svga-work-overlay').fadeIn('fast');
      a('#svga-canvas').attr({
        width: c.shareImageSize,
        height: c.shareImageSize,
      });
      q && q.show();
      r && r.show();
      var b = a('#svga-svgmain').html();
          ...
          if ('saved' === b) {
            ...
            var e = a('<img />')
              ...
              .on('load', function () {
                ...
                'undefined' !== typeof this.naturalWidth &&
                0 !== this.naturalWidth
                  ? (a('#svga-share-image').empty().append(e),
                    a('#svga-work-overlay').fadeIn('fast'),
                    a('#svga-share-block').fadeIn('fast'))
                  : (a('#svga-message-text')
                      .html(f.alertErrorImage)
                      .addClass('svga-error'),
                    a('#svga-work-overlay').fadeIn('fast'),
    ...
    a('#svga-share-twitter').on('click', function () {
      window.open(
        'https://twitter.com/intent/tweet?original_referer=' +
          encodeURIComponent(c.shareLink) +
          '&text=' +
          encodeURIComponent(c.shareTitle) +
          '%20' +
          encodeURIComponent(c.shareLink),
        'Twitter',
  ...
  var ba = navigator.userAgent.match(/(iPad|iPhone|iPod)/g) ? !0 : !1,
    ...
    O = [
      ...
      f.authoredMsg,
      '<a href="https://svgavatars.com" target="_blank" rel="nofollow">svgAvatars.com</a></p><div id="svga-start-overlay">&nbsp;</div><div id="svga-work-overlay">&nbsp;</div><div id="svga-loader">',
      f.waitMsg,
  ...
  b.supported &&
    ...
    a('#svga-start-girls').on('click', function () {
      ...
      a.ajax({
        url:
          c.pathToFolder + 'json/svgavatars-female-data.json',
        dataType: 'json',
        cache: !0,
        global: !1,
      })
