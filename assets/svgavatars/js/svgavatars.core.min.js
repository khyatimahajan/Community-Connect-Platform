...
window.jQuery(document).ready(function (a) {
  function L(A, e) {
    ...
    for (m = 0; m < aa.length; m++)
      a('#svga-' + aa[m] + '-icon').append(
        '<svg class="svga-share-icons" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 32 32" preserveAspectRatio="xMinYMin meet"><path class="svga-share-icons-path" fill="' +
          W[m] +
          '" d="' +
          x[aa[m]] +
          '"/></svg>'
  ...
  b.supported &&
    ...
    a('#svga-start-boys').on('click', function () {
      a('#svga-gender').hide();
      a.ajax({
        url: c.pathToFolder + 'json/svgavatars-male-data.json?ver=' + c.version,
        dataType: 'json',
        cache: !0,
        global: !1,
      })
    ...
    a('#svga-start-girls').on('click', function () {
      ...
      a.ajax({
        url:
          c.pathToFolder + 'json/svgavatars-female-data.json?ver=' + c.version,
        dataType: 'json',
        cache: !0,
        global: !1,
      })
